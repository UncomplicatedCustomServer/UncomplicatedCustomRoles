...
public class EventCustomRole : CustomRole
{
    ...
    /// <summary>
    ///     Called after a <see cref="LabApi.Features.Wrappers.Player" /> used a
    ///     <see cref="LabApi.Features.Wrappers.UsableItem" /> item.
    /// </summary>
    ...
    /// <summary>
    ///     Called before a <see cref="LabApi.Features.Wrappers.Player" /> has stopped the use of a
    ///     <see cref="API.Features.Items.Usable" /> item.
    /// </summary>
    ...
    /// <summary>
    ///     Called after a <see cref="LabApi.Features.Wrappers.Player" /> has stopped the use of a
    ///     <see cref="API.Features.Items.Usable" /> item.
    /// </summary>
    ...
    /// <remarks>
    ///     If <see cref="PlayerChangingRoleEventArgs.IsAllowed" /> is set to <see langword="false" /> when Escape is
    ///     <see langword="true" />, awards will still be given to the escapee's team even though they will 'fail' to escape.
    ///     Use <see cref="OnEscaping" /> to block escapes instead.
    /// </remarks>
