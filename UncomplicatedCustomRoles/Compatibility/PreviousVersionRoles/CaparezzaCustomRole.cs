...
#nullable enable
    ...
    internal class CaparezzaCustomRole : IPreviousVersionRole
    {
        ...
        public virtual CaparezzaSpawnBehaviour? SpawnSettings { get; set; } = new();
        ...
        public CustomRole ToCustomRole()
        {
            return new()
            {
                ...
                SpawnSettings = SpawnSettings is null ? null : new()
                {
                    ...
                    SpawnZones = SpawnSettings.SpawnZones.GetZoneTypes(),
                    SpawnRooms = SpawnSettings.SpawnRooms.GetRoomTypes(),
